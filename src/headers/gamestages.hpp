...
bool confirm_preview(const int &l, const int &w) {
    WINPAN preview_scr(l, w, 0, 0);
    preview_scr.wprint(1, 1, "This will be the size of the minefield");
    preview_scr.wprint(2, 1, "ENTER to confirm | any key to reconfigure");
...
void prompt_minefield_assignment(void) {
    WINPAN prompt_scr(LINES - 1, COLS - 1, 0, 0);
